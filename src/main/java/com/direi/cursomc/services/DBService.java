...
public class DBService {
	...
	public void stantiateTestDatabase() throws ParseException {
		...
		Categoria cat9 = new Categoria(null, "Hospitalar");
		...
		Produto p6 = new Produto(null, "Colcha", 200.00);
		Produto p7 = new Produto(null, "TV true Color", 1200.00);
		Produto p8 = new Produto(null, "Roçadira", 200.00);
		Produto p9 = new Produto(null, "Abajou", 100.00);
		Produto p10 = new Produto(null, "Pendente", 180.00);
		Produto p11 = new Produto(null, "Shampoo", 90.00);
		Produto p12 = new Produto(null, "Lapis", 1.00);
		...
		cat9.getProdutos().addAll((Arrays.asList(p12)));
